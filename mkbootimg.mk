...
$(INSTALLED_BOOTIMAGE_TARGET): $(MKBOOTIMG) $(INTERNAL_BOOTIMAGE_FILES) $(BOOT_SIGNER)
	...
	$(BOOT_SIGNER) /boot $@ device/nubia/nx612j/bootsignature/verity.pk8 device/nubia/nx612j/bootsignature/verity.x509.pem $@
...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	$(BOOT_SIGNER) /recovery $@ device/nubia/nx612j/bootsignature/verity.pk8 device/nubia/nx612j/bootsignature/verity.x509.pem $@
